...
public class SlowingMissile extends Missile {

    private static final float BASE_RADIUS = 3.0f;
    private static final float BASE_SPEED = 12.5f;

    private static final float BASE_TIME_SLOWED = 1.0f;

    private float slowPercentage;

    public SlowingMissile(Point origin, Point destination, float damage, float slowPercentage) {
